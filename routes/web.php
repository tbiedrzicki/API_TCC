...
$router->group(['middleware' => 'apicheck'], function() use ($router){
    ...
    $router->get('/grupo/{id}',['as'=> 'areas.get', 'uses' => 'GrupoController@one']);
    $router->post('/grupo',['as'=> 'areas.post', 'uses' => 'GrupoController@store']);
    $router->put('/grupo/{id}', ['as' => 'areas.put', 'uses' => 'grupoController@update']);
    $router->delete('/grupo/{id}', ['as' => 'areas.delete', 'uses' => 'GrupoController@destroy']);
